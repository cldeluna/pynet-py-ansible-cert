...
def main():
    ...
    if arguments.connect:
        ...
        for a_dev in devices:
            ...
            # dev_conn = ConnectHandler(device_type=a_dev.device_type, ip=a_dev.ip_address, username=a_dev.credentials.username,
            #                           password = a_dev.credentials.password, port=a_dev.port)
            #
            # msg = "Executing command <" + show_cmd + "> on device " + a_dev.device_name
            # print "\n"
            # print "=" * len(msg)
            # print msg
            # print "=" * len(msg)
            #
            # print dev_conn.send_command(show_cmd)
